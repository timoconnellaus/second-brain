/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3279160f1c9eee6b01363be0a7a46664)
// Runtime types generated with workerd@1.20260114.0 2025-09-27 
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "SecondBrainAgent";
	}
	interface Env {
		NOTION_TOKEN: string;
		...
		NOTION_DB_PEOPLE: string;
		NOTION_DB_PROJECTS: string;
		NOTION_DB_IDEAS: string;
		NOTION_DB_ADMIN: string;
		NOTION_DB_INBOX_LOG: string;
		SecondBrainAgent: DurableObjectNamespace<import("./src/index").SecondBrainAgent>;
	}
}
